...
func stagedReceiptColumns() []string {
	return []string{
		...
		"CATALOG_FINGERPRINT", "PROVISION_EPOCH", "MANIFEST_HASH", "PLAN_HASH", "EXTERNAL_ID", "GENERATION", "ACQUISITION_ID", "LEASE_EPOCH",
...
func stagedReceiptValues(receipt managedStagedReceipt) []any {
	return []any{
		...
		receipt.catalogFingerprint, receipt.provisionEpoch, receipt.manifestHash, receipt.planHash, receipt.externalID, receipt.generation, receipt.acquisitionID, receipt.leaseEpoch,
