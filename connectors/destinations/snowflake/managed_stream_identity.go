...
func streamDestinationManifestHash(cfg streamConfig, intent connector.DeliveryIntent, planHash, contentHash, offsetToken string) string {
	encoded, _ := json.Marshal(struct {
		...
		RequestJournalCreatedOn string            `json:"request_journal_created_on"`
		...
		ReceiptsCreatedOn: cfg.receiptsCreatedOn, ChannelStateCreatedOn: cfg.channelStateCreatedOn, RequestJournalCreatedOn: cfg.requestJournalCreatedOn, SourceSchema: cfg.sourceSchema, SourceTable: cfg.sourceTable,
