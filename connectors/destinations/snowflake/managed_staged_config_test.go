...
func stagedValidOptions(t *testing.T) (string, map[string]string) {
	...
	options := map[string]string{
		...
		"managed_table": "WALLABY_CHANGELOG", "managed_receipts_table": "WALLABY_RECEIPTS",
		"managed_landing_table": "WALLABY_LANDING", "managed_authority_table": "WALLABY_AUTHORITY",
		"managed_target_manifest_table": "WALLABY_TARGET_MANIFESTS", "managed_file_format": "WALLABY_JSON",
		...
		"managed_receipts_created_on": created, "managed_landing_created_on": created,
		"managed_authority_created_on": created, "managed_target_manifest_created_on": created,
