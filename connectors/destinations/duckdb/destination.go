...
func defaultDuckDBTypeMappings() map[string]string {
	return map[string]string{
		...
		"geometry":                    "VARCHAR",
		"geography":                   "VARCHAR",
		"postgis.geometry":            "VARCHAR",
		"postgis.geography":           "VARCHAR",
		"ext:postgis.geometry":        "VARCHAR",
		"ext:postgis.geography":       "VARCHAR",
		"ext:hstore.hstore":           "JSON",
		"ext:hstore":                  "JSON",
		"ext:citext.citext":           "VARCHAR",
		"ext:citext":                  "VARCHAR",
		"ext:ltree.ltree":             "VARCHAR",
		"ext:ltree":                   "VARCHAR",
		"ext:vector.vector":           "FLOAT[]",
		"ext:vector":                  "FLOAT[]",
	}
}
