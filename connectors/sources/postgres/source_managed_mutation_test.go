...
func TestManagedSourceOpenRejectsLegacyMutationBeforeNetwork(t *testing.T) {
	base := map[string]string{
		optDSN: "postgres://127.0.0.1:1/unreachable", optSlot: "slot", optPublication: "publication", optManaged: "true",
