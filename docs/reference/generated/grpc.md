...
| ENDPOINT_TYPE_REDPANDA | 12 | Redpanda is Kafka API-compatible. Redpanda Iceberg topics require an enterprise license. Configure Iceberg in Redpanda, not WALlaby. |
