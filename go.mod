...
// hamba import path (used by pkg/wire's OCF codec) but forwards every symbol to
// the patched github.com/iskorotkov/avro/v2 v2.33.1 via type aliases, keeping a
// single Avro type universe. See third_party/hamba-avro-shim/README.md for full
// provenance.
