...
var authorityMutableTables = []string{
	...
	"destination_revisions", "delivery_manifests", "delivery_attempts", "delivery_attempt_evidence", "delivery_receipts", "source_ack_intents", "source_ack_receipts", "delivery_retention_roots", "source_ack_retention_roots", "managed_part_reservations", "managed_part_reservation_parts",
...
var requiredManagedColumns = map[string][]string{
	...
	"managed_part_reservations":      {"reservation_id", "flow_incarnation_id", "flow_id", "generation", "acquisition_id", "lease_epoch", "destination_revision_id", "logical_batch_id", "content_hash", "resource", "server_active_parts", "planned_parts", "capacity", "reservation_state", "released_at"},
	"managed_part_reservation_parts": {"reservation_id", "part_kind", "part_ordinal", "query_id", "part_state", "durable_at", "released_at"},
...
var requiredManagedConstraints = []requiredManagedObject{
	...
	{table: "managed_part_reservations", name: "managed_part_reservations_release_complete"},
