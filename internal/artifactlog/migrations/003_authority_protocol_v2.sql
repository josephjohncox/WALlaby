...
BEGIN
  FOREACH table_name IN ARRAY ARRAY[
    'canonical_schemas','artifact_streams','artifact_objects','artifact_upload_attempts',
    'artifact_publications','artifact_publication_objects','artifact_deliveries','artifact_quota_accounts',
    'artifact_quota_reservations','artifact_gc_claims','artifact_delivery_attempts','artifact_delivery_receipts'
  ] LOOP
