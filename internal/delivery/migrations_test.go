...
func TestManagedPartReservationMigrationRequiresAuthorityV2(t *testing.T) {
	...
	source := string(raw)
	for _, required := range []string{"CREATE TABLE managed_part_reservations", "CREATE TABLE managed_part_reservation_parts", "managed_part_reservations_manifest_fkey", "managed_part_reservations_budget_idx", "wallaby_require_authority_protocol_v2", "reservation_state IN ('reserved','released')", "part_state IN ('reserved','durable','released')"} {
