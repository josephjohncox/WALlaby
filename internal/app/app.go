...
func Run(ctx context.Context, cfg *config.Config) error {
	...
	if cfg.Kubernetes.Enabled {
		dispatcher, err := orchestrator.NewKubernetesDispatcher(ctx, orchestrator.KubernetesConfig{
			...
			SnowflakeStreamingRESTEnabled:       cfg.Snowflake.StreamingREST.Enabled,
			SnowflakeStreamingRESTConfigMapName: cfg.Snowflake.StreamingREST.PolicyConfigMapName,
			SnowflakeStreamingRESTConfigMapKey:  cfg.Snowflake.StreamingREST.PolicyConfigMapKey,
