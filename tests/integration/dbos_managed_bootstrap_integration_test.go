...
func TestDBOSManagedBootstrapProductionWiring(t *testing.T) {
	...
	destinationSpec := connector.RuntimeSpec{Name: "target", Type: connector.EndpointPostgres, Options: map[string]string{"dsn": dsn, "managed": "true", "batch_mode": "target", "destination_revision_id": "dbos-live-target-v1", "synchronous_commit": "on"}}
